...
<head>
   ...
   <title>vLine - Sistema Operacional</title>

   <link rel="stylesheet" href="{{ URL::to('vendor/fontawesome/css/font-awesome.min.css') }}">
   <link rel="stylesheet" href="{{ URL::to('app/css/fonts/impactreg/font.css') }}" id="maincss">
   <!-- SIMPLE LINE ICONS-->
...
<body class="layout"> <!-- layout-boxed -->
   <div class="wrapper">
   ...
   <script src="{{ URL::to('vendor/moment/min/pt-br.js') }}"></script>
   <!-- SKYCONS-->
